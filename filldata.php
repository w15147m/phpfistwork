...
WHERE city.newname IS not null AND city.locale = 'en'
...
<body>
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<form method='post' action='savefilleddata.php'>";
                            echo "<input type='hidden' name='id' value='" . $row["id"] . "'>";
                            echo "<td><input type='text' name='newname' value='" . $row["newname"] . "'></td>";
                            echo "<td><button type='submit' name='save-button'>Save</button></td>";
                            echo "</form>";
                            echo "</tr>";
    ...
    <?php
     echo '<ul>';
     echo '<li><a href="filldata.php?page=1">First</a></li>';
    $sql2 = "SELECT * FROM locations__cities__translations WHERE newname IS not NULL AND locale = 'en'";
    ...
    if (mysqli_num_rows($result2) > 0) {
        ...
        if ($current_page > 1) {
            echo '<li><a href="filldata.php?page='.($current_page - 1).'">Prev</a></li>';
        }
        
        for ($i = $start; $i <= $end; $i++) {
            echo '<li><a href="filldata.php?page='.$i.'"';
            ...
            echo '<li><a href="filldata.php?page='.($current_page + 1).'">Next</a></li>';
        }
        echo '<li><a href="filldata.php?page='.$totalpages.'">Last</a></li>';
        echo '</ul>';
    }
    ?>
</div>
