...
$sql = "SELECT city.*, country.country_id AS country_id, country.name AS country_name
FROM locations__cities__translations AS city , locations__countries_translations AS country where city.country_id = country.country_id and country.locale='en' and 
 city.newname IS NULL AND city.locale = 'en'
...
<body>
    ...
    $sql2 = "SELECT * FROM locations__cities__translations WHERE newname IS NULL AND locale = 'en'";
